...
class ApiClient {
  ApiClient({this.basePath = 'http://https'}) {
  }
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable = false}) {
    try {
      switch (targetType) {
        ...
        case 'ListImagesResponse':
          return ListImagesResponse.fromJson(value);
        case 'ListImagesResponseImages':
          return ListImagesResponseImages.fromJson(value);
        default:
          dynamic match;
