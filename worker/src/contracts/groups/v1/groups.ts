    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated groups.v1.Group groups */ 1:
          message.groups.push(
            Group.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
