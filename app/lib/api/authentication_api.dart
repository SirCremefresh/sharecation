...
class AuthenticationApi {
  ...
  Future<CreateAuthenticationWithFirebaseResponse> createJwt({
    ...
    // var fake = CreateAuthenticationWithFirebaseResponse(ok: Authenticated(
    //     jwtString: "sadf", data: AuthenticatedData(exp: 23, sub: "adsf")));
    // var fakeString = fake.toProto3Json();

    try {
      return CreateAuthenticationWithFirebaseResponse.fromBuffer(_response.data!);
