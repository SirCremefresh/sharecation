...
// @generated from protobuf file "authentication/v1/authentication.proto" (package "authentications.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message authentications.v1.AuthenticatedData
 */
...
/**
 * @generated from protobuf message authentications.v1.Authenticated
 */
export interface Authenticated {
    /**
     * @generated from protobuf field: string jwtString = 1;
     */
    jwtString: string;
    /**
     * @generated from protobuf field: authentications.v1.AuthenticatedData data = 2;
     */
    data?: AuthenticatedData;
}
/**
 * @generated from protobuf message authentications.v1.CreateAuthenticationRequest
 */
...
/**
 * @generated from protobuf message authentications.v1.CreateAuthenticationResponse
 */
export interface CreateAuthenticationResponse {
    ...
    response: {
        oneofKind: "ok";
        /**
         * @generated from protobuf field: authentications.v1.Authenticated ok = 1;
         */
        ok: Authenticated;
    } | {
        oneofKind: "error";
...
class AuthenticatedData$Type extends MessageType<AuthenticatedData> {
    constructor() {
        super("authentications.v1.AuthenticatedData", [
...
/**
 * @generated MessageType for protobuf message authentications.v1.AuthenticatedData
 */
export const AuthenticatedData = new AuthenticatedData$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Authenticated$Type extends MessageType<Authenticated> {
    constructor() {
        super("authentications.v1.Authenticated", [
            { no: 1, name: "jwtString", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Authenticated): Authenticated {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string jwtString */ 1:
                    message.jwtString = reader.string();
                    break;
                case /* authentications.v1.AuthenticatedData data */ 2:
    ...
    internalBinaryWrite(message: Authenticated, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* authentications.v1.AuthenticatedData data = 2; */
        if (message.data)
...
/**
 * @generated MessageType for protobuf message authentications.v1.Authenticated
 */
...
class CreateAuthenticationRequest$Type extends MessageType<CreateAuthenticationRequest> {
    constructor() {
        super("authentications.v1.CreateAuthenticationRequest", [
            { no: 1, name: "jwtString", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message authentications.v1.CreateAuthenticationRequest
 */
...
class CreateAuthenticationResponse$Type extends MessageType<CreateAuthenticationResponse> {
    constructor() {
        super("authentications.v1.CreateAuthenticationResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateAuthenticationResponse): CreateAuthenticationResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* authentications.v1.Authenticated ok */ 1:
                    message.response = {
                        oneofKind: "ok",
    ...
    internalBinaryWrite(message: CreateAuthenticationResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* authentications.v1.Authenticated ok = 1; */
...
/**
 * @generated MessageType for protobuf message authentications.v1.CreateAuthenticationResponse
 */
