...
class CreateRoleBindingRequest$Type extends MessageType<CreateRoleBindingRequest> {
  ...
  create(
    value?: PartialMessage<CreateRoleBindingRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CreateRoleBindingRequest,
  ): CreateRoleBindingRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class CreateRoleBindingResponse$Type extends MessageType<CreateRoleBindingResponse> {
  ...
  create(
    value?: PartialMessage<CreateRoleBindingResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CreateRoleBindingResponse,
  ): CreateRoleBindingResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* authentication.v1.RoleBinding ok */ 1:
          message.response = {
            oneofKind: 'ok',
            ok: RoleBinding.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.response as any).ok,
  ...
  internalBinaryWrite(
    ...
    if (message.response.oneofKind === 'ok')
      RoleBinding.internalBinaryWrite(
        message.response.ok,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class DeleteRoleBindingRequest$Type extends MessageType<DeleteRoleBindingRequest> {
  ...
  create(
    value?: PartialMessage<DeleteRoleBindingRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DeleteRoleBindingRequest,
  ): DeleteRoleBindingRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class DeleteRoleBindingResponse$Type extends MessageType<DeleteRoleBindingResponse> {
  ...
  create(
    value?: PartialMessage<DeleteRoleBindingResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DeleteRoleBindingResponse,
  ): DeleteRoleBindingResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class GetRolesOfUserResponse$Type extends MessageType<GetRolesOfUserResponse> {
  ...
  create(
    value?: PartialMessage<GetRolesOfUserResponse>,
