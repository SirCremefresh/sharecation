...
class User extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'User', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dev_tools.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jwtString')
  ...
  @$pb.TagNumber(2)
  $core.String get jwtString => $_getSZ(1);
  @$pb.TagNumber(2)
  set jwtString($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasJwtString() => $_has(1);
  @$pb.TagNumber(2)
  void clearJwtString() => clearField(2);
}
...
class CreateUserResponse extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, CreateUserResponse_Response> _CreateUserResponse_ResponseByTag = {
    1 : CreateUserResponse_Response.ok,
    2 : CreateUserResponse_Response.error,
    0 : CreateUserResponse_Response.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateUserResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dev_tools.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<User>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ok', subBuilder: User.create)
  ...
  CreateUserResponse_Response whichResponse() => _CreateUserResponse_ResponseByTag[$_whichOneof(0)]!;
  void clearResponse() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  User get ok => $_getN(0);
  @$pb.TagNumber(1)
  set ok(User v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOk() => $_has(0);
  @$pb.TagNumber(1)
  void clearOk() => clearField(1);
  @$pb.TagNumber(1)
  User ensureOk() => $_ensure(0);
